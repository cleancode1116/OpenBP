 ...
 */
public class SimpleTypeItemDecimalImpl extends SimpleTypeItemStringImpl
{
	//////////////////////////////////////////////////
	// @@ Construction
	//////////////////////////////////////////////////
	 ...
	 * Default constructor.
	 */
	public SimpleTypeItemDecimalImpl()
	{
	}
		...
		throws ValidationException
	{
		...
		if (s != null)
		{
			...
			s = NumberUtil.validateNumberString(s, nf, true);
			...
			if (member != null)
			{
				...
				{
					if (decimal.scale() > definedPrecision)
					{
						throw new ValidationException("Precision may not exceed " + definedPrecision + " digits");
					}

					if (decimal.scale() < definedPrecision)
					{
						decimal = decimal.setScale(definedPrecision, BigDecimal.ROUND_HALF_UP);
					}
				}
			}
