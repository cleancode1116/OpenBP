 ...
 */
public class SimpleTypeItemDateImpl extends SimpleTypeItemStringImpl
{
	//////////////////////////////////////////////////
	// @@ Construction
	//////////////////////////////////////////////////
		...
		throws ValidationException
	{
		...
		if (s != null)
		{
			DateFormat df = DateTimeUtil.getDateFormat(member, true, false, locale);
			Date date = df.parse(strValue, new ParsePosition(0));

			if (date == null)
			{
				throw new ValidationException("Invalid date value (example for a valid date: " + df.format(new Date()) + ")");
			}
