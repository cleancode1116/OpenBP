 ...
 */
public class FileBinaryResourceSpec extends BinaryResourceSpec
{
	/**
	 * Default constructor.
	 */
	 ...
	 */
	public FileBinaryResourceSpec(URL url)
	{
		super(url);
	}
	 ...
	 */
	public FileBinaryResourceSpec(URL url, byte [] content)
	{
		super(url, content);
	}
		...
		throws Exception
	{
		...
		ResourceEntry entry = new ResourceEntry(url, getContent());
