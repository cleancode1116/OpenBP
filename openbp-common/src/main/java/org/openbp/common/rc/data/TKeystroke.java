 ...
 */
package org.openbp.common.rc.data;
 ...
 * @author Andreas Putz
 */
public class TKeystroke extends ResourceItem
{
	//////////////////////////////////////////////////
	...
	{
		return ResourceItemTypes.DATA_KEYSTROKE;
	}
	...
	public void initializeFromDOM(ResourceCollection res, Element source, String group)
	{
		...
		if (s != null)
		{
			resourceObject = KeyStroke.getKeyStroke(s);
		}
	}
}
