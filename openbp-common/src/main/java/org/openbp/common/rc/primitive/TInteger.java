 ...
 * @author Andreas Putz
 */
public class TInteger extends ResourceItem
{
	//////////////////////////////////////////////////
	...
	{
		return ResourceItemTypes.PRIMITIVE_INTEGER;
	}
	...
	public void initializeFromDOM(ResourceCollection res, Element source, String group)
	{
		...
		if (s != null)
		{
			try
			{
				resourceObject = Integer.valueOf(s);
			}
			catch (NumberFormatException e)
			{
				LogUtil.error(getClass(), "Resource $0: Not an integer value.", getErrorName());
				return;
			}
		}
	}
