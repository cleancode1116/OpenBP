...
/**
 * Get element by key.
 * Implementation of the GetMapElement activity handler.
 * Retrieves a map element by its key.
 * Returns null if the map contains no such element.
 * 
 ...
 */
public class GetMapElementHandler
	// {{*Custom extends*
	// }}*Custom extends*
	// {{*Custom interfaces*
	implements Handler
