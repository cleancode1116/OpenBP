...
/**
 * Get next element.
 * Implementation of the NextElement activity handler.
 * Returns the next element of an iterator.
 * 
 ...
 *     Parameter 'Object'
 */
public class NextElementHandler
	// {{*Custom extends*
	// }}*Custom extends*
	// {{*Custom interfaces*
	implements Handler
	// }}*Custom interfaces*
{
		...
		throws Exception
	{
		...
		Iterator iterator = (Iterator) hc.getParam(PARAM_ITERATOR);
