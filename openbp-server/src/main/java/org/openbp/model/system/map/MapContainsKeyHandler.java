 ...
 * Implementation of the MapContainsKey activity handler.
 * If the Checks map contains a the specified key, the 'Yes' exit will be chosen, otherwise the 'No' exit.
 * 
 ...
 *   Socket 'No'
 */
public class MapContainsKeyHandler
	// {{*Custom extends*
	// }}*Custom extends*
	// {{*Custom interfaces*
	implements Handler
