...
/**
 * Save object.
 * Implementation of the SaveObject activity handler.
 * Saves an object to the persistence store that is configured for the executing model.
 * 
 ...
 *   Socket 'Out'
 *     Parameter 'Object': The saved object (usually the argument itself)
 */
public class SaveObjectActivity
	// {{*Custom extends*
	// }}*Custom extends*
	// {{*Custom interfaces*
	implements Handler
