...
/**
 * Entity lifecycle event listener base class.
 * Implements all methods of the interface as empty methods.
 *
 * @author Heiko Erhardt
 */
public abstract class EntityLifecycleListenerBase
	implements EntityLifecycleListener
{
	/**
	 * Default constructor.
	 */
	public EntityLifecycleListenerBase()
	{
	}

	/**
	 * Template method that is called after the object has been created.
