 ...
 * class rather than as inner class of the large plugin (see {@link AbstractPlugin#getExternalOptionModuleClasses}).
 *
 * @author Stephan Moritz
 */
public abstract class ExternalOptionModule extends OptionModule
{
