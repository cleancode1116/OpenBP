 ...
 */
public class ParamValueIntegerPage extends ParamValuePage
{
	//////////////////////////////////////////////////
	// @@ Data members
	//////////////////////////////////////////////////
	 ...
	 */
	public ParamValueIntegerPage(ParamValueWizard wizard, NodeParam param)
	{
		...
		JLabel heading = new JLabel(wizard.getResource().getRequiredString("wizard.page.value.integer"));
